...
export const CASES = [
  ...
  {
    images: [
      { src: `${IMG}/case-hefei-bank-poster.jpg`, alt: "Postal Savings Bank branch at Hefei Wanda with Crystal Film LED displays behind the glazing" },
      { src: `${IMG}/case-hefei-postal-bank-04.jpg`, alt: "Bank branch glazing carrying blue Crystal Film LED brand content" },
