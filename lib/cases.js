...
export const CASES = [
  {
    ...
    product: "Crystal Film LED Screen",
    description:
  ...
  },
  {
    ...
    product: "Crystal Film LED Screen · P6.0",
    description:
  ...
  {
    images: [
      { src: `${IMG}/case-cambodia-lasvegas-sun-01.jpg`, alt: "Curved holographic LED wall on the gaming floor of the Las Vegas Sun casino in Cambodia" },
  ...
  {
    images: [
      { src: `${IMG}/case-hefei-postal-bank-04.jpg`, alt: "Postal Savings Bank branch at Hefei Wanda with Crystal Film LED displays behind the glazing" },
      { src: `${IMG}/case-hefei-postal-bank-02.jpg`, alt: "Blue animated content on a Crystal Film LED screen inside the bank entrance" },
      { src: `${IMG}/case-hefei-postal-bank-03.jpg`, alt: "Crystal Film LED display at the Hefei Wanda bank branch, third view" },
    ],
    location: "Hefei · China",
    title: "Postal Savings Bank",
    product: "Crystal Film LED Screen",
    description:
      "Crystal Film LED panels sit just behind the glazing of a Postal Savings Bank branch at Hefei Wanda — saturated blue brand animation visible from the street, with the banking hall kept bright and open behind it.",
