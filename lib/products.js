...
/* Home-page "Featured Projects" rail — the four flagship case videos named in
   the redesign spec §9: Daxing Airport + Coca-Cola (Crystal Film), Xinpai
   showroom + Estée Lauder (Holographic). Each pick resolves against the
   owning product's `cases` array so the rail always mirrors the case walls. */
const FEATURED_CASE_PICKS = [
  { slug: "crystal-film", title: "Beijing Daxing International Airport" },
