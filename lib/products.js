...
export const PRODUCTS = [
  ...
  },
  {
    ...
    cardImage: `${IMG}/products/smd-holo-content-floral.jpg`,
    placeholder: false,
    shortDescription:
    ...
    gallery: [
      { src: `${IMG}/products/smd-holo-content-floral.jpg`, alt: "Freestanding transparent LED poster screen with floral content" },
      { src: `${IMG}/products/smd-holo-render-tall.jpg`, alt: "Transparent LED poster screen, full-height view" },
      { src: `${IMG}/products/smd-holo-content-pair.jpg`, alt: "A pair of freestanding transparent LED poster screens" },
    ],
    specs: {
