 ...
 * ProductCard / lib/structured-data.js read them.
 *
...
export const PRODUCTS = [
     ...
     Project product: sold per m², engineered per facade.                  */
  {
    ...
    /* Card image: cafe storefront scene — the Coca-Cola shot already fronts the
       home Featured Projects rail; one image per surface on the home page. */
    cardImage: `${IMG}/scenes/scene-cafe-storefront.jpg`,
    shortDescription:
      "Self-adhesive transparent LED film — 2.5 mm thin, 90%+ transparency.",
    description:
    ...
    /* Hero swapped off the Daxing footage — that clip and its poster carry an
       Envato watermark on the screen content. Changchun is the flagship clean
       Crystal Film install on camera. */
    hero: {
      video: `${VID}/case-changchun.mp4`,
      poster: `${IMG}/cases/changchun-video.jpg`,
      stats: [
    ...
    features: [
      {
        ...
        description:
          "90–95% transparency depending on pitch. Patented invisible-grid circuits with in-bead driver ICs keep daylight and sightlines unobstructed — this clip looks straight through a running P8 screen from behind.",
        media: {
          type: "video",
          src: `${VID}/feature-transparency-back.mp4`,
          poster: `${IMG}/cases/case-uzbekistan-back-poster.jpg`,
        },
      },
      {
        icon: "layers",
      ...
      },
      {
        ...
        description:
          "A minimum bend diameter of just 6 cm lets the film wrap cylinders, arcs, and irregular glazing that rigid panels can never follow — here, two modules spliced around a full cylinder.",
        media: {
          type: "video",
          src: `${VID}/feature-flex-cylinder.mp4`,
          poster: `${IMG}/cases/case-flex-cylinder-poster.jpg`,
        },
      },
      {
        icon: "feather",
    ...
    models: [
      {
        ...
        images: [
          `${IMG}/cases/case-xian-saga-mall-p625.jpg`,
          `${IMG}/cases/case-coca-cola-experience-p625.jpg`,
          `${IMG}/cases/case-japan-storefront-p625.jpg`,
          `${IMG}/cases/case-hongkong-yoga-studio-p625.jpg`,
        ],
        specs: {
      ...
      },
      {
        ...
        images: [
          `${IMG}/cases/case-overseas-conference-window-p8.jpg`,
          `${IMG}/cases/case-uzbekistan-mall-p8.jpg`,
          `${IMG}/cases/case-dongguan-park-p8.jpg`,
        ],
        specs: {
          "Pixel Pitch": "8 × 8 mm",
          "Module Size": "1000 × 400 mm",
      ...
      },
      {
        ...
        images: [
          `${IMG}/scenes/scene-corporate-facade.jpg`,
          `${IMG}/cases/case-dongguan-p20-poster.jpg`,
        ],
        specs: {
    ...
    /* Phase 2 optimization: the wall carries every named Crystal Film install.
       Crystal *screen* (晶芯屏) projects — Macau StarWorld, Changchun, Hefei —
       moved to the holographic wall where that product family lives.
       Beijing Daxing returns poster-only: every second of its footage plays an
       Envato-watermarked demo reel on screen, so the clip stays unpublished
       and the poster is a hand-picked clean frame (no legible watermark). */
    cases: [
      {
      ...
      },
      {
        ...
        poster: `${IMG}/cases/case-honda-dealership-p6.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-xian-saga-mall-p625.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-changan-showroom-p625.jpg`,
        featured: false,
      },
      {
        title: "Street-Front Storefront",
        model: "P6.25",
        location: "Japan",
        video: `${VID}/case-japan.mp4`,
        poster: `${IMG}/cases/case-japan-storefront-p625.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-uzbekistan-mall-p8.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-hongkong-yoga-studio-p625.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-guangxi-bank-p625.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-dongguan-park-p8.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-dongguan-p20-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-sk-retail-p6.jpg`,
        featured: false,
      },
      {
      ...
      },
      {
        ...
        poster: `${IMG}/cases/case-huizhou-p10-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-shop-window-p8-poster.jpg`,
        featured: false,
      },
      {
        title: "Conference Room Window",
        model: "P8",
        location: "Overseas Install",
        video: `${VID}/case-meeting-room-p8.mp4`,
        poster: `${IMG}/cases/case-meeting-room-p8-poster.jpg`,
        featured: false,
      },
    ],
    ...
    gallery: [
      { src: `${IMG}/cases/case-xian-saga-mall-p625.jpg`, alt: "Crystal Film LED Screen across the Helly Hansen storefront at Xi'an SAGA Mall" },
     ...
     Project product: sold per m², close-viewing premium installs.        */
  {
    ...
    shortDescription:
      "Borderless holographic mesh screen — under 3 mm thick, up to 93% transparency.",
    description:
    ...
    hero: {
      ...
      poster: `${IMG}/cases/case-xinpai-poster.jpg`,
      stats: [
    ...
    applications: [
      ...
      { src: `${IMG}/scenes/scene-holo-render-02.jpg`, label: "Airport Hall", alt: "Holographic invisible screen carrying flight information in an airport hall" },
    ...
    /* Case posters are hand-picked frames exported from each clip
       (case-*-poster.jpg) so the cover matches the footage exactly.
       Phase 2: crystal-screen (晶芯屏) installs — StarWorld, Changchun, Hefei —
       moved here from the Crystal Film wall (the screen family belongs with
       SMD holographic), plus the immersive tunnel and two supplier case clips. */
    cases: [
      {
      ...
      },
      {
        ...
        poster: `${IMG}/cases/case-estee-lauder-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-baiyun-airport-poster.jpg`,
        featured: false,
      },
      {
      ...
      },
      {
        ...
        poster: `${IMG}/cases/case-cambodia-casino-poster.jpg`,
        featured: false,
      },
      {
      ...
      },
      {
        ...
        poster: `${IMG}/cases/case-hefei-bank-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-nanning-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/mashan-video.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-immersive-tunnel-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-holo-lobby-wave-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-holo-auto-showroom-poster.jpg`,
        featured: false,
      },
    ],
     ...
     Retail product: sold per unit to merchants and resellers.            */
  {
    ...
    shortDescription:
      "Plug-and-play flexible LED sign — app + remote control, live in 5 minutes.",
    description:
    ...
    /* Phase 2: five real North-American storefronts joined the three product
       demos — footage from the retail-scenarios library, H.264 <8 MB each. */
    cases: [
      {
      ...
      },
      {
        ...
        poster: `${IMG}/cases/case-grocery-liquor-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-jewelry-store-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-realtor-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-accessories-store-poster.jpg`,
        featured: false,
      },
      {
        ...
        poster: `${IMG}/cases/case-liquor-store-poster.jpg`,
        featured: false,
      },
    ],
...
/* Home-page "Featured Projects" rail — four flagship case videos: Baiyun
   Airport (in place of the redesign spec's Daxing pick, whose only footage
   carries an Envato watermark), Coca-Cola (Crystal Film), Xinpai showroom +
   Estée Lauder (Holographic). Each pick resolves against the owning product's
   `cases` array so the rail always mirrors the case walls. */
const FEATURED_CASE_PICKS = [
  { slug: "holographic", title: "Baiyun Airport — Dream Blue Pavilion" },
  { slug: "crystal-film", title: "Coca-Cola Experience Center" },
  { slug: "holographic", title: "Xinpai Semiconductor Showroom" },
  { slug: "holographic", title: "Estée Lauder Flagship" },
];

/** Flagship cases for the home rail, each linking to its product's case wall. */
export function getFeaturedCases() {
  return FEATURED_CASE_PICKS.map(({ slug, title }) => {
    const product = getProduct(slug);
    const caseStudy = product?.cases?.find((c) => c.title === title);
    if (!caseStudy) return null;
    return {
      ...caseStudy,
      productName: product.name,
      href: `/products/${slug}#cases`,
    };
  }).filter(Boolean);
}
