...
export const PRODUCTS = [
     ...
     Project product: sold per m², engineered per facade.                  */
  {
    ...
    /* The Beijing Daxing case was dropped: its only footage and poster show an
       Envato watermark on the screen content (unusable). The airport story on
       the home rail is carried by Baiyun Airport (holographic) instead.
       2026-06 optimization: case wall expanded 5 → 15 with newly transcoded
       library footage (each clip H.264, <10 MB, no audio). */
    cases: [
      {
