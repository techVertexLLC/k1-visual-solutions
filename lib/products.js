...
export const CATEGORIES = [
  ...
  { key: "led-signage", label: "LED Signage — Matrix Panels", short: "LED Signage" },
];
...
export const PRODUCTS = [
  {
    ...
    pixelPitch: "P3.91",
    cardImage: `${IMG}/products/smd-p391-product-01.jpg`,
    placeholder: false,
    shortDescription:
      "High-resolution holographic transparent panel for close-viewing retail windows and lobby features.",
    valueProposition:
      "Turn any storefront glass into a captivating holographic canvas — delivering crisp, depth-rich visuals that stop foot traffic while keeping the space behind fully visible. At a metre or two away the image stays razor-sharp, so retail windows, showroom plinths, and lobby features read as premium rather than pixelated. It's the transparent LED display to specify when the audience is close and the brand impression has to land.",
    description:
    ...
    gallery: [
      { src: `${IMG}/products/smd-p391-product-01.jpg`, alt: "SMD Holographic LED P3.91 panel, angled studio view" },
      { src: `${IMG}/products/smd-p391-product-02.jpg`, alt: "Curved multi-panel SMD Holographic LED P3.91 run showing the transparent mesh" },
      { src: `${IMG}/products/smd-p391-product-03.jpg`, alt: "SMD Holographic LED P3.91 panel, front view" },
      { src: `${IMG}/products/smd-p391-product-04.jpg`, alt: "SMD Holographic LED P3.91 panel, three-quarter studio view" },
      ...
      { src: `${IMG}/products/holographic-coin-comparison-01.jpg`, alt: "Transparent LED mesh module close-up with a coin for scale" },
    ],
    specs: {
      "Pixel pitch": "3.91 mm",
  ...
  },
  {
    ...
    category: "holographic",
    pixelPitch: "P6.25",
    cardImage: `${IMG}/products/smd-p625-product-01.jpg`,
    placeholder: false,
    shortDescription:
      "Balanced-pitch holographic panel — brightness and transparency tuned for mid-range architectural spans.",
    valueProposition:
      "The go-to choice for architects designing atriums, escalator voids, and feature walls — bright enough to cut through daylight, transparent enough to preserve the open feel. P6.25 balances resolution, brightness, and cost across mid-range spans, so a large architectural surface stays on budget without looking compromised. Specify it where viewers stand several metres back and the building has to keep breathing.",
    description:
    ...
    gallery: [
      { src: `${IMG}/products/smd-p625-product-01.jpg`, alt: "SMD Holographic LED P6.25 panel, three-quarter studio view" },
      { src: `${IMG}/products/smd-p625-product-03.jpg`, alt: "Curved multi-panel SMD Holographic LED P6.25 wall in the studio" },
      { src: `${IMG}/products/smd-p625-product-02.jpg`, alt: "SMD Holographic LED P6.25 panel, front view" },
      { src: `${IMG}/products/smd-p625-product-04.jpg`, alt: "SMD Holographic LED P6.25 panel, angled studio view" },
      ...
      { src: `${IMG}/products/holographic-coin-comparison-02.jpg`, alt: "Transparent LED mesh surface with a coin for scale" },
    ],
    specs: {
      "Pixel pitch": "6.25 mm",
  ...
  },
  {
    ...
    category: "holographic",
    pixelPitch: "P10.4",
    cardImage: `${IMG}/products/smd-p104-product-01.jpg`,
    placeholder: false,
    shortDescription:
      "Maximum-transparency holographic panel for large facades and long-distance viewing.",
    valueProposition:
      "Cover large building facades and expo halls at a fraction of the cost per square metre — ideal for venues where viewing distance makes ultra-fine pitch unnecessary. Up to 90% transparency lets a building keep its daylight and its view by day, then carry full-motion content after dark. It's the most economical way to put a media facade on a curtain wall read from across a street or plaza.",
    description:
    ...
    gallery: [
      { src: `${IMG}/products/smd-p104-product-01.jpg`, alt: "SMD Holographic LED P10.4 panel, angled studio view" },
      { src: `${IMG}/products/smd-p104-product-02.jpg`, alt: "SMD Holographic LED P10.4 panel, front view" },
      { src: `${IMG}/products/smd-p104-product-03.jpg`, alt: "SMD Holographic LED P10.4 panel, mesh detail from the front" },
      { src: `${IMG}/products/smd-p104-product-04.jpg`, alt: "Wide horizontal SMD Holographic LED P10.4 panel showing the open mesh" },
      { src: `${IMG}/scenes/scene-corporate-facade.jpg`, alt: "Transparent LED media facade carrying colour across a corporate building's glazing (render)" },
    ],
    specs: {
      "Pixel pitch": "10.4 mm",
  ...
  },
  {
    ...
    valueProposition:
      "A freestanding digital poster that replaces static signage in retail lobbies and airport terminals — plug-and-play with a built-in media player, so no custom mounting or construction is required. Roll it into a window or floor space and it turns the spot into a high-clarity transparent display without walling off the light or the view behind it. For brands that need motion on the floor this week, not next quarter, it's the fastest path to a premium digital presence.",
    description:
    ...
    gallery: [
      ...
      { src: `${IMG}/scenes/scene-panel-01.jpg`, alt: "Transparent LED poster screen rendering a firework burst against a dark studio" },
  ...
  },
  {
    ...
    valueProposition:
      "A self-adhesive LED film that transforms any existing glass surface into a digital display — no structural modification, no frame, just peel-and-stick transparency. Millimetres thin and near-invisible when off, it conforms to curved glass and columns a rigid panel never could, adding almost no load to the structure. Specify it for retrofits and curved architecture where a conventional screen simply won't fit.",
    description:
  ...
  },
  {
    ...
    valueProposition:
      "Ultra-thin crystal LED film bonded directly onto glass — completely invisible when off, strikingly vivid when on. The closest thing to a true 'invisible display', it carries bright, high-refresh content while the view stays pristine behind it. This is the surface to specify when a space needs the display to disappear and the glass to stay glass.",
    description:
    ...
    gallery: [
      ...
      { src: `${IMG}/scenes/scene-restaurant-hospitality.jpg`, alt: "Restaurant glazing carrying a dish promotion on a see-through display (render)" },
