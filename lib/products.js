...
export const PRODUCTS = [
  ...
  },
  {
    ...
    cardImage: `${IMG}/scenes/scene-install-front-facing.jpg`,
    placeholder: false,
    shortDescription:
    ...
    gallery: [
      { src: `${IMG}/scenes/scene-install-front-facing.jpg`, alt: "Transparent LED poster screen installed front-facing in a storefront window" },
  ...
  },
  {
    ...
    category: "series-f",
    pixelPitch: "P3.91",
    cardImage: `${IMG}/applications/app-display-wall.jpg`,
    placeholder: false,
    shortDescription:
    ...
    gallery: [
      { src: `${IMG}/applications/app-display-wall.jpg`, alt: "Crystal Film Display forming a large transparent display wall" },
      { src: `${IMG}/scenes/scene-flexible-film.jpg`, alt: "Crystal Film Display conforming to a curved glass surface" },
