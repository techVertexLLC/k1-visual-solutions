...
/**
 * ItemList for a collection page (e.g. the /projects portfolio). The entries
 * have no standalone routes, so each ListItem deep-links to its anchor on the
 * collection page (`path` like "/projects#coca-cola-experience").
 */
